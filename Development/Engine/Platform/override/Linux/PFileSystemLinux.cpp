...
EIGHTGINE_REGISTER_PLATFORM(PFileSystemLinux)
...
std::filesystem::path PFileSystemLinux::ProjectModulesDir()
{
    return ProjectExecutableDir().parent_path() / EIGHTGINE_MODULES_DIR_NAME;
}

std::filesystem::path PFileSystemLinux::ProjectPlugInModulesDir()
{
