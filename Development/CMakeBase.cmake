...
function(eightgine_link_dependency)
    ...
    if(ARG_DEPENDENCY_INCLUDE_DIR)
        target_include_directories("${DIRTY_ARG_MODULE_OR_EXECUTABLE_NAME}" PUBLIC ${ARG_DEPENDENCY_INCLUDE_DIR})
    endif()

    if(ARG_DEPENDENCY_LIB_DIR)
        target_link_directories("${DIRTY_ARG_MODULE_OR_EXECUTABLE_NAME}" PUBLIC "${ARG_DEPENDENCY_LIB_DIR}")
    endif()
    ...
    target_link_libraries("${DIRTY_ARG_MODULE_OR_EXECUTABLE_NAME}" PUBLIC "${DIRTY_ARG_DEPENDENCY_NAME}")
    target_compile_definitions("${DIRTY_ARG_MODULE_OR_EXECUTABLE_NAME}" PRIVATE ${ARG_DEPENDENCY_DEFINITIONS})
endfunction()
