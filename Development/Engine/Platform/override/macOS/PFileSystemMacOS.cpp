...
EIGHTGINE_REGISTER_PLATFORM(PFileSystemMacOS)
...
std::filesystem::path PFileSystemMacOS::ProjectModulesDir()
{
    return ProjectExecutableDir().parent_path() / EIGHTGINE_MODULES_DIR_NAME;
}

std::filesystem::path PFileSystemMacOS::ProjectPlugInModulesDir()
{
